...
execute at @s facing entity @p[nbt={Inventory:[{Slot:-106b,components:{"minecraft:enchantments":{levels:{"tcc:honey_hole":1}}}}]}] eyes run tp @s ^ ^ ^.1
execute at @s facing entity @p[nbt={SelectedItem:{components:{"minecraft:enchantments":{levels:{"tcc:honey_hole":1}}}}}] eyes run tp @s ^ ^ ^.1
...
execute store result entity @s Motion.[0] double 0.009 run scoreboard players get #x2 tcc_misc
execute store result entity @s Motion.[1] double 0.009 run scoreboard players get #y2 tcc_misc
execute store result entity @s Motion.[2] double 0.009 run scoreboard players get #z2 tcc_misc
