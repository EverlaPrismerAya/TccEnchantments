...
scoreboard players add @s[scores={yamato_max_damage_count=20..}] yamato_max_damage_count 2
damage @s[scores={yamato_max_damage_count=..10}] 0.5 tcc:fragile by @p[distance=0.1..]
